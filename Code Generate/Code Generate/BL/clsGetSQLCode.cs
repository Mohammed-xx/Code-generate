...
{
    internal class clsGetSQLCode
    {

        //"انشاء كود اضافة سطر حسب الجدول المختار"
        ...
        //"انشاء كود تحديث سطر حسب الجدول المختار"
        ...
        //"انشاء كود حذف سطر حسب الجدول المختار"
        ...
        //"انشاء كود التحقق من سطر حسب الجدول المختار"
        ...
        //"انشاء كود جلب جميع السطور حسب الجدول المختار"
        ...
        //"تنفيذ جميع الاوامر السابقه حسب الجدول المختار"

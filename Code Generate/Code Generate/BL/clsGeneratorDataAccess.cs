...
namespace Code_Generate.BL
{
    public class clsGeneratorDataAccess
    {

        //"تحويل نوع البيانات الى فنكشن ف الداتا ريدر"
        ...
        //"تحويل نوع البيانات الموجود ف قاعدة البيانات الى نوع البيانات الموجود ف اللغة"
        ...
        //"انشاء كود لترحيل البيانات حسب الجدول المختار"
        ...
        //"إنشاء كود اضافة سطر ف قاعدة البيانات حسب الجدول المختار"
        ...
        //"إنشاء كود جلب سطر من قاعدة البيانات حسب الجدول المختار"
        ...
        //"إنشاء كود تحديث سطر ف قاعدة البيانات حسب الجدول المختار"
        ...
        //"إنشاء كود التحقق من وجود سطر ف قاعدة البيانات حسب الجدول المختار"
        ...
        //"إنشاء كود حذف سطر ف قاعدة البيانات حسب الجدول المختار"
        ...
        //"انشاء كود لجلب جميع السطور من قاعدة البيانات حسب الجدول المختار"
        ...
        //"تنفيذ جميع الاوامر السابقة دفعة واحدة"
